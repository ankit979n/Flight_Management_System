...
<body>
    <h1 align="center" style="color:white;">Welcome To The Flight Management System Admin</h1>
    <div class="navbar">
        <ul>
            <li><a href="javascript:void(0);"><b>Airport</b></a>
                <ul>
                    <li><a href="/airportadd">Airport Addition</a></li>
                    <li><a href="/airportall">All Airports</a></li>
                </ul></li>
            <li><a href="javascript:void(0);"><b>Route</b></a>
                <ul>
                    <li><a href="/routeadd">Route Addition</a></li>
                    <li><a href="/routeall">All Routes</a></li>
                </ul></li>
            <li><a href="javascript:void(0);"><b>Flight</b></a>
                <ul>
                    <li><a href="/flightadd">Add Flight</a></li>
                    <li><a href="/flightresults">All Flight</a></li>
                </ul></li>
           
            <li><a href="javascript:void(0);"><b>Passenger</b></a>
                <ul>
                    <li><a href="/passengerDetails">Passenger Details</a></li>
                </ul></li>
            <li><a href="javascript:void(0);"><b>Ticket</b></a>
                <ul>
                    <li><a href="/ticketsBooked">Tickets Booked</a></li>
                </ul></li>
